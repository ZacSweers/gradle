...
====
include::sample[dir="webApplication/quickstart/groovy",files="build.gradle[tags=use-war-plugin]"]
include::sample[dir="webApplication/quickstart/kotlin",files="build.gradle.kts[tags=use-war-plugin]"]
====
...
`components.web`::
A link:{javadocPath}/org/gradle/api/component/SoftwareComponent.html[SoftwareComponent] for <<publishing.adoc#publishing_overview,publishing>> the production WAR created by the `war` task.
...
====
include::sample[dir="webApplication/customized/groovy",files="build.gradle[tags=customization]"]
include::sample[dir="webApplication/customized/kotlin",files="build.gradle.kts[tags=customization]"]
====
